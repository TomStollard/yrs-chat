...
IP addresses in JavaScript environments. It runs on both CommonJS runtomes
...
Sometomes you will want to convert IPv6 not to a compact string representation (with
