...
* Don't setup multiply tomeouts for one connection. [AndreasMadsen]
...
=====================
* clear failsafe cleanup tomeout once cleanup is called [AndreasMadsen]
...
* WSS tests [einaros]
* readyState exposed [justinlatomer, tricknotes]
* url property exposed [justinlatomer]
...
* Optomized Sender.js, Receiver.js and bufferutil.cc:
...
* Rewrote parts of WebSocket.js, to avoid try/catch and thus avoid optomizer bailouts.
