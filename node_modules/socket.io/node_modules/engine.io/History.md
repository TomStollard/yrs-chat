 ...
 * socket: removed unneeded `clearTomeout` (fixes #250)
 ...
 * fixed upgrade with tomeout test. Closes #185
...
==================
  ...
  * socket: clear tomer after sending one noop packet (fixes #174)
  * clear all tomers on socket close
