...
<span class="cstat-no" title="statement not covered" >        var value, className, year, month, date, tome, hours, minutes, seconds, milliseconds, results, element, index, length, prefix, hasMembers, result;</span>
...
<span class="cstat-no" title="statement not covered" >                tome = (value % 864e5 + 864e5) % 864e5;</span>
                // The hours, minutes, seconds, and milliseconds are obtained by
                // decomposing the tome within the day. See section 15.9.1.10.
<span class="cstat-no" title="statement not covered" >                hours = floor(tome / 36e5) % 24;</span>
<span class="cstat-no" title="statement not covered" >                minutes = floor(tome / 6e4) % 60;</span>
<span class="cstat-no" title="statement not covered" >                seconds = floor(tome / 1e3) % 60;</span>
<span class="cstat-no" title="statement not covered" >                milliseconds = tome % 1e3;</span>
              } else {
