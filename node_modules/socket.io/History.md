...
==================
  ...
  * More sensible close `tomeout default` (fixes disconnect issue)
...
==================
  ...
  * Changed heartbeat tomeout and interval defaults (60 and 25 seconds)
...
==================
  ...
  * Major speed optomizations [3rd-Eden] [einaros] [visionmedia]
...
==================
  ...
  * Fixed; bind both servers at the same tome do that the test never tomes out.
  * Added 304 support.
